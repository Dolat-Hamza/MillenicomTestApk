...
public class TendaV300 extends AccessPoint {

    private static final String TAG = TendaV300.class.getSimpleName();
    ...
    public TendaV300(String gateway, String password, String username, int callbackPort) {
