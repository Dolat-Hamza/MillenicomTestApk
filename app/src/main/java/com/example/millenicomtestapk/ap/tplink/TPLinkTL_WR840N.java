...
public class TPLinkTL_WR840N extends AccessPoint {

    private static final String TAG = TPLinkTL_WR840N.class.getSimpleName();

    private static final String DEFAULT_USERNAME = "admin";
    private static final String DEFAULT_PASSWORD = "admin2";
    ...
    public TPLinkTL_WR840N(String gateway, String username, String password, int callbackPort) {
    ...
    public String getJSCodeForUrl(String url) {
        //Timber.e(TAG + ", " + "getJSCodeForUrl,  url: " + url);
