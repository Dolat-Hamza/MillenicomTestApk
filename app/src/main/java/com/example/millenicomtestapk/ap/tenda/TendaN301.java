...
public class TendaN301 extends AccessPoint {

    private static final String TAG = TendaN301.class.getSimpleName();
    ...
    public TendaN301(String gateway, String password, String username, int callbackPort) {
