...
public class AirTiesAir5444TT extends AccessPoint {

    private static final String TAG = AirTiesAir5444TT.class.getSimpleName();
    ...
    public AirTiesAir5444TT(String gateway, String username, String password, int callbackPort) {
    ...
    public String getJSCodeForUrl(String url) {
        ...
        if (url.equals(getFormattedGateway() + LOGIN_SUFFIX)) {
            ...
            return "javascript:{" +
                    "parent.frames['mainFrame'].document.getElementsByName('user')[0].value= '" + getUsername() + "';" +
                    "parent.frames['mainFrame'].document.getElementsByName('password')[0].value='" + getPassword() + "';" +
