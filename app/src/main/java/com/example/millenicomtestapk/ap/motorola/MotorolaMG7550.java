...
public class MotorolaMG7550 extends AccessPoint {

    public static final String TAG = MotorolaMG7550.class.getSimpleName();
    ...
    public MotorolaMG7550(String gateway, String username, String password, int callbackPort) {
