...
public class HuaweiHG532s extends AccessPoint {

    public static final String TAG = HuaweiHG532s.class.getSimpleName();
    ...
    public HuaweiHG532s(String gateway, String username, String password, int callbackPort) {
        ...
        if (url.equals(getFormattedGateway() + LOGIN_SUFFIX)) {
            if (state == State.LOGIN_STATE) {
                ...
                return "javascript:{" +
                        ...
                        "amb_sendcode(document.getElementById('txt_Password'), 's');}).then(function(){" +
                        "setTimeout(function(){" +
