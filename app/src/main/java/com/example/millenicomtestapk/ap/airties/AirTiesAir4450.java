...
public class AirTiesAir4450 extends AccessPoint {

    private static final String TAG = AirTiesAir4450.class.getSimpleName();
    ...
    public AirTiesAir4450(String gateway, String password, int callbackPort) {
    ...
    public String getJSCodeForUrl(String url) {
        ...
        if (url.equals(getFormattedGateway() + LOGIN_SUFFIX))
            ...
            return "javascript:{" +
                    ...
                    "}" +
                    "else {" +
                    "if (parent.frames['mainFrame'].document.getElementById('cmb_chanbw') != null) {" +
                    ...
                    "if (parent.frames['mainFrame'].document.getElementById('__ML_save') != null) {" +
                    "parent.frames['mainFrame'].document.getElementById('__ML_save').click();" +
                    "}" +
                    "else if (parent.frames['mainFrame'].document.getElementById('SaveButton') != null){" +
