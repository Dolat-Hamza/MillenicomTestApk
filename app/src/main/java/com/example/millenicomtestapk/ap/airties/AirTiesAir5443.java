...
public class AirTiesAir5443 extends AccessPoint {

    private static final String TAG = AirTiesAir5443.class.getSimpleName();
    ...
    public AirTiesAir5443(String gateway, String password, int callbackPort) {
