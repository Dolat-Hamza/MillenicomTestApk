...
public class AirTiesAir5342 extends AccessPoint {

    private static final String TAG = AirTiesAir5342.class.getSimpleName();
    ...
    public AirTiesAir5342(String gateway, String password, int callbackPort) {
