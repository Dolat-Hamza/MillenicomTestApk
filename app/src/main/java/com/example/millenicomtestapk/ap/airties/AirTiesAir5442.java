...
public class AirTiesAir5442 extends AccessPoint {

    private static final String TAG = AirTiesAir5442.class.getSimpleName();
    ...
    public AirTiesAir5442(String gateway, String password, int callbackPort) {
