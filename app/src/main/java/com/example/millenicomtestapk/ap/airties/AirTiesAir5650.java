...
public class AirTiesAir5650 extends AccessPoint {

    private static final String TAG = AirTiesAir5650.class.getSimpleName();
    ...
    public AirTiesAir5650(String gateway, String username, String password, int callbackPort) {
