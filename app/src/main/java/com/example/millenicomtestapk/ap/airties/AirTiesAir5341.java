...
public class AirTiesAir5341 extends AccessPoint {

    private static final String TAG = AirTiesAir5341.class.getSimpleName();
    ...
    public AirTiesAir5341(String gateway, String password, int callbackPort) {
