...
public class HuaweiHG658c extends AccessPoint {
    ...
    public static final String TAG = HuaweiHG658c.class.getSimpleName();
    ...
    public HuaweiHG658c(String gateway, String username, String password, int callbackPort) {
        ...
        if (url.equals(getFormattedGateway() + LOGIN_SUFFIX)) {
            ...
            return "javascript:{" +
                   initAmbeent() +
                    ...
                    "var menuFrame = document.getElementById('listfrm').contentDocument || document.getElementById('listfrm').contentWindow.document;" +
                    "menuFrame.getElementById('link_User_1_1').click();" +
                    "isWLANClicked = true;" +
                    "} else {" +
